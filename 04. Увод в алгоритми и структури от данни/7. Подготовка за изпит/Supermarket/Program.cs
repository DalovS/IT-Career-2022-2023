...
namespace Program
{
    public class Program
    {
        ...
        {
              List<Product> sort =  supermarket.SortDescendingByPrice();
            Console.WriteLine("The cheapest product is: " + sort[sort.Count - 1].Name);
        }
        private static void SortAscendingByName()
        {
            List<Product> sort = supermarket.SortAscendingByName();
            Console.WriteLine("First product is: " + sort[0].Name);
        }
