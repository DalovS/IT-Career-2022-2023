...
namespace Program
{
    public class Program
    {
        ...
        {
            List<Book> sorted = bookLibrary.SortByRating();
			Console.WriteLine("The worst book is with rating: " + sorted[sorted.Count - 1].Rating);
        }
        private static void SortByTitle()
        {
           
			List<Book> sorted = bookLibrary.SortByTitle();
			Console.WriteLine("First book is: " + sorted[0].Title);
        }
